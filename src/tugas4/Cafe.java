...
public class Cafe extends TempatMakan{
    ...
    public void addMenu(Menu menu) {
        ...
        if(newMenu == null){
            ...
            newMenu.setNama(menu.getNama());
            newMenu.setHarga(menu.getHarga());
            System.out.println("Menu " + menu.getNama() + " berhasil diupdate ke daftar!");
        }
    }
}
